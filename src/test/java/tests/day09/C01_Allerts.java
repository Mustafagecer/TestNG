...
public class C01_Allerts {
    ...
    public void dismissAlert(){
        ...
        Assert.assertFalse(resultYaziElementi.getText().contains("successfuly"),"Sonuc successfuly yazisini iceroyor");
    ...
    public void sendKeysAlert(){
        ...
        Assert.assertTrue(resultYaziElementi.getText().contains("mustafa"),"Sonuc girilen ismi icermiyor");
